...
import { getAllIds, getData } from '../../lib/data-others';
    ...
    <Layout>
      <article className="card col-6">
        <div className="card-body">
          ...
          <h6 className="card-subtitle mb-2 text-body-secondary">{itemData.other_adddress}</h6>
          <div className="card-text" dangerouslySetinnerHTML={{__html: itemData.other_description}}/>
        </div>
      </article>
    </Layout>
  );
